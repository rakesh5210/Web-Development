    ...
    <body>
        ...
        <div class="login_box">
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3 align="center">Your order is confirmed. Thank you for shopping with us <b>:)</b></h3>
                        <hr>
                        <p align="center">Click <a href="product.php">here</a> to purchase any other items.</p>
                    </div>
                </div>
            </div>
        </div>   
